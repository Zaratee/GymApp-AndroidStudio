...
public class AdminModificarDatosNutriologo extends AppCompatActivity {

    EditText etxtNombre, etxtApellido, etxtTelefono;
    RadioButton rdbtnMatutino, rdbtnVespertino;
    String Cuenta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_modificar_datos_nutriologo);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        etxtNombre = (EditText) findViewById(R.id.etxtNombre_AdminModificarDatosNutriologo);
        etxtApellido = (EditText) findViewById(R.id.etxtApellido_AdminModificarDatosNutriologo);
        etxtTelefono = (EditText) findViewById(R.id.etxtTelefono_AdminModificarDatosNutriologo);
        txtvHora = (TextView) findViewById(R.id.txtvHorario_AdminModificarDatosNutriologo);

        txtvTitulo = (TextView) findViewById(R.id.txtvTitulo_AdminModificarDatosNutriologo);

        btnModificar = (Button) findViewById(R.id.btnModificarCliente_AdminModificarDatosNutriologo);
        btnTomarFoto = (Button) findViewById(R.id.btnTomarFoto_AdminModificarDatosNutriologo);

        chckBoxHorario = (CheckBox) findViewById(R.id.chkboxCambiarHorario_AdminModificarNutriologo2);


        imgvUsuario = (CircularImageView) findViewById(R.id.imgvUsuario_AdminModificarDatosNutriologo);
        ...
        Glide.with(AdminModificarDatosNutriologo.this).load("http://thegymlife.online/php/fotos/imagenesNutriologo/"+Cuenta+".jpg").apply(RequestOptions.skipMemoryCacheOf(true))
    ...
    private void conexionBDModificarInfo() {
        ...
        String url = "http://thegymlife.online/php/admin/Administrador_Modificar_Nutriologo_Datos.php?registro=" +
        ...
        JsonObjectRequest peticion = new JsonObjectRequest
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    switch(valor) {
                                        case "OK":
                                            Toast.makeText(AdminModificarDatosNutriologo.this,"Nutriologo actualizado",Toast.LENGTH_SHORT).show();
                                            uploadImage();
                                            Intent intent = new Intent(AdminModificarDatosNutriologo.this,admin_menu.class);
                                            startActivity(intent);
                                            break;
                                        case "TELEFONO":
                                            Toast.makeText(AdminModificarDatosNutriologo.this, "Teléfono ya asignado", Toast.LENGTH_SHORT).show();
                                            break;
                                        case "ERROR":
                                            Toast.makeText(AdminModificarDatosNutriologo.this,"Rellenar los datos",Toast.LENGTH_SHORT).show();
                                    }
                        ...
                        , new Response.ErrorListener()
                {
                    ...
                    {
                        Toast.makeText(AdminModificarDatosNutriologo.this,"Error conexion",Toast.LENGTH_SHORT).show();
                    }
                });
        RequestQueue x = Volley.newRequestQueue(AdminModificarDatosNutriologo.this);
        x.add(peticion);
    ...
    private void conexionBDCambiarHorario() {
        ...
        String url = "http://thegymlife.online/php/admin/Administrador_Modificar_Nutriologo_Horario.php?registro="+Cuenta;
        url = url.replaceAll(" ", "%20");
        ...
        JsonObjectRequest peticion = new JsonObjectRequest
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    switch(valor) {
                                        case "OK":
                                            Toast.makeText(AdminModificarDatosNutriologo.this, "Horario cambiado", Toast.LENGTH_SHORT).show();
                                            break;
                                        case "ERROR":
                                            Toast.makeText(AdminModificarDatosNutriologo.this,"Horario no cambiado",Toast.LENGTH_SHORT).show();
                                            break;
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                        ...
                        , new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error)
                    {
                        Toast.makeText(AdminModificarDatosNutriologo.this,"Error php",Toast.LENGTH_SHORT).show();
                    }
                });
        RequestQueue x = Volley.newRequestQueue(AdminModificarDatosNutriologo.this);
        x.add(peticion);
                                ...
                                try {
                                    ...
                                    switch(valor) {
                                        case "OK":
                                            ...
                                            break;
                                        case "ERROR":
                                            Toast.makeText(AdminModificarDatosNutriologo.this,"Fallo de conexión",Toast.LENGTH_SHORT).show();
                                    }
    ...
    private void uploadImage() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL_Cliente,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(KEY_CUENTA, "Nutriologo");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode){
            case COD_SELECCIONA:
                ...
                break;
            case COD_FOTO:
                MediaScannerConnection.scanFile(AdminModificarDatosNutriologo.this, new String[]{path}, null,
