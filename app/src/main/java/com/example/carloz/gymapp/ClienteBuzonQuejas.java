...
public class ClienteBuzonQuejas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_buzon_quejas);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        btnCrearQueja = (Button) findViewById(R.id.btnCrearQueja_ClienteBuzoQuejas);
        txtvTitulo = (TextView) findViewById(R.id.txtvNoActionTitulo_ClienteBuzonQuejas);
        ...
        recyclerClientes = (RecyclerView) findViewById(R.id.listvQuejas_ClienteBuzoQuejas);
    ...
    private void conexionBDQuejas() {
        String url = "http://thegymlife.online/php/cliente/Cliente_Lista_Quejas.php?registro="+Login.Registro;
        ...
        JsonObjectRequest peticion = new JsonObjectRequest
                        ...
                        , new Response.ErrorListener()
                {
                    ...
                    {
                        Toast.makeText(ClienteBuzonQuejas.this,"Error php",Toast.LENGTH_SHORT).show();
                    }
                });
        RequestQueue x = Volley.newRequestQueue(ClienteBuzonQuejas.this);
        x.add(peticion);

    }

    private void clickbtnCrearQueja() {
        btnCrearQueja.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ClienteBuzonQuejas.this,ClienteCrearQueja.class);
                startActivity(intent);
            }
        });
    }
    public void onBackPressed(){
        Intent intent = new Intent(ClienteBuzonQuejas.this,ClienteMenu.class);
        startActivity(intent);
