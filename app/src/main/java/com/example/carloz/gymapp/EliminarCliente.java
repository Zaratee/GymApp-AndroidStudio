...
public class EliminarCliente extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBuscar = (ImageButton) findViewById(R.id.btnBuscar_EliminarCliente);
        etxtBusqueda = (EditText) findViewById(R.id.etxtBuscar_EliminarCliente);

        txtvTitulo = (TextView) findViewById(R.id.txtvNoActionEliminar_EliminarCliente);
        ...
        recyclerClientes = (RecyclerView) findViewById(R.id.listvClientesEliminar_EliminarCliente);
    ...
    private void conexionBDBusqueda() {
            ...
            InputMethodManager manager = (InputMethodManager)getSystemService(EliminarCliente.INPUT_METHOD_SERVICE);
            ...
            JsonObjectRequest peticion = new JsonObjectRequest
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        adapter.contexto= EliminarCliente.this;
                                        for (int i =0; i<jsonArray.length();i++){
                                            ...
                                            listaClientes.add(new ItemClienteInstructor(nombre,registro,apellido,""));
                                        }
                            ...
                            , new Response.ErrorListener()
                    {
                        ...
                        {
                            Toast.makeText(EliminarCliente.this,"Error php",Toast.LENGTH_SHORT).show();
                        }
                    });
            RequestQueue x = Volley.newRequestQueue(EliminarCliente.this);
            x.add(peticion);
