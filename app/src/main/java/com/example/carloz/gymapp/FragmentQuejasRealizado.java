...
public class FragmentQuejasRealizado extends Fragment {
    ...
    private void conexionBDQuejasInstructorRealizado() {
            ...
            listaClientes.clear();
            String url = "http://thegymlife.online/php/admin/Administrador_Lista_Entrenador_Quejas_Realizado.php";
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        for (int i =0; i<jsonArray.length();i++){
                                            ...
                                            listaClientes.add(new ItemListaQuejasAdmin(nombre,registro,apellido,quejaRegistro,"Realizado"));
                                        }
